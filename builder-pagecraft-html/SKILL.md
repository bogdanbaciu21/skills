...
description: Builder.io Fusion plus Pagecraft/UX OS workflow for creating or hardening high-quality branded HTML artifacts, reports, dashboards, portal pages, prototypes, and visual documents. Use when the user asks for "awesome HTML", Builder-backed HTML/UI generation, Fusion/Builder.io work, Pagecraft finishing, text-wrap fixes, number/table formatting, Bogdan Baciu branded HTML, Acme/client branded HTML, or review of Builder-generated visual output.
---
