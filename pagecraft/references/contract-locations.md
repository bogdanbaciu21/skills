...
- LJB portal shell checks:
  `bash brian-portal/scripts/check-pagecraft.sh` from `LJB`
- LJB dashboard shell checks:
  `python3 dashboard-poc/scripts/wrap_brand_in_portal.py --verify` from `LJB`
