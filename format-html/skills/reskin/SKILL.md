...
```json
{
  ...
  "apply_command": "python3 client-portal/scripts/apply-brand-frame.py {page} \"{eyebrow}|{headline_pre}|{headline_em}|{subhead}|{page_label}\"",
  ...
  "pages": [
    { "path": "client-portal/use-cases/uc-01.html",
